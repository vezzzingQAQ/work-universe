window.addEventListener("load", () => {
        ...
        pdisplay(other) {
            ...
            if (other.state == 2 && subMag < 2000) {
                ...
                if (this.startT >= 1600) {
                    ...
                    circleCenter(0, 0, min(this.radius, this.startT / 50));
                }
                //加上光影
                if (other.c3t > 20 && other.state == 3) {
                ...
                if (this.startT >= 1600) {
                    ...
                    arc(0, 0, min(this.radius, this.startT / 50), cangle - PI / 2, cangle + PI / 2);
                }
                popMatrix();
            }
        }
    ...
    class Sun extends GravityMover {
        ...
        pdisplay() {
            ...
            switch (this.state) {
                ...
                case 0: {
                    this.c0t += (this.lightRayTime - this.c0t) / 50;
                ...
                case 4: {
                    ...
                    if (!OPEN_OPACITY) {
                        ...
                        for (let i = 0; i < 10; i++) {
                            ...
                            fill(rgba(250, 250, 250, min(this.c4t / 1000, 0.05)));
                            circleCenter(this.position.x, this.position.y, currentRadius);
                        }
                    }
                    //遮罩层
    ...
    function genStars() {
        ...
        if (random(0, 10) < 1) {
            ...
            for (let i = 0; i < map(currentSun.mass, sunMinMass, sunMaxMass, 20, followerTotal); i++) {
